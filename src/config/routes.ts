export const routes = {
  eCommerce: {
    ...
    editSubcategory: (id: string) => `/ecommerce/subcategories/${id}/edit` ,
    ...
    createVariation: '/ecommerce/variations/create', // Add this path
    createAttribute: '/ecommerce/attributes/create',
    promoCodes: '/ecommerce/promo-codes',
    createPromoCode: '/ecommerce/promo-codes/create',
    editPromoCode: (id: string) => `/ecommerce/promo-codes/${id}/edit`,
    deletePromoCode: (id: string) => `/ecommerce/promo-codes/${id}/delete`, 
    sales: '/ecommerce/sales',
    createSale: '/ecommerce/sales/create', // Add this path
  },
  activity: {
    list: '/activity/list',
    details: (id: string) => `/activity/details/${id}`,
  },
  searchAndFilter: {
